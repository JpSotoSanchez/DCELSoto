...
def dibujarCara(cara, subPlot, color, rellenar=False, label=None):
    if cara.aristasExternos:
        coords_externas = []
        arista_actual = cara.aristasExternos
...
for layer in listaLayers:
    ...
    for i, cara in enumerate(listaCaras):
        ...
        dibujarCara(cara, ax, color=color, rellenar=esta_activa, label=label_actual)
...
# ══════════════════════════════════════════════════════════════════════════════
# PARTE 3 — ACTUALIZACIÓN FINAL DE LA DCEL
# ══════════════════════════════════════════════════════════════════════════════
